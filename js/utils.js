...
const calculateCartTotal = (cart) => {
  ...
  // ! reduce ==> Bir dizi üzerindeki tüm elemanları dönerek bir işleme tabi tutar.
  // Bu metot belirtilen işlevi gerçekleştirdikten sonra geriye toplu bir sonuç döndürür

  // ! Bu metot diziAdı.reduce((1,2)=>{},3) şeklinde kullanılır
  // Buradaki 1.değer toplam sonucun aktarılacağı bir değişkendir 2.değerse currentValue'ya karşılık gelir.
  // Buda her dönülen elemanın değerini alır

  // ! reduce'un 3. parametresi bir başlangıç değeri vardır.
  //  Bu değer, reduce'un başladığında dizi elemanları dönmek için ilk değerdir.
  // Bu değer varsayılan olarak 0'dır.
};
